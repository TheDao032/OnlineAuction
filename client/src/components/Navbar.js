    ...
    return (
        <div className="container">
            ...
            <div className="menu-bar">
                <ul>
                    {allCategory.map(cat => (
                        <li className="active"> <Link to='/services' className='a'>{cat.cateName}</Link>
                            <div className="sub-menu-1">
                                <ul>
                                    {cat.subCategories.map(sub =>(
                                        <li><Link to='/services' className="a">{sub.cateName}</Link></li>
                                    ))}                               
                                </ul>
                            </div>
            ...
            <div className="form_div">
                <form onSubmit={handleSubmit}>
                    <div className="pseudo-search">
                        <input onChange={(e) => handle(e)} onKeyPress={KeyPress} id="value" type="text" placeholder="Search..." autofocus required />
                        <button className="fa fa-search" type="submit">tìm</button>
                    </div>
                </form>
            </div>
