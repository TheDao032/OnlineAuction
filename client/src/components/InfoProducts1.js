...
function InfoProducts1() {
    ...
    const fetchProduct = async () => {
        const response = await axios
            .get("https://onlineauctionserver.herokuapp.com/api/product/list-time-out")
            .catch((err) => {
                console.log("Err", err);
            });
    ...
    const fetchProduct1 = async () => {
        const response1 = await axios
            .get("https://onlineauctionserver.herokuapp.com/api/product/list-biggest-offer")
            .catch((err) => {
                console.log("Err", err);
            });
    ...
    const fetchProduct2 = async () => {
        const response2 = await axios
            .get("https://onlineauctionserver.herokuapp.com/api/product/list-biggest-price")
            .catch((err) => {
                console.log("Err", err);
            });
                            ...
                            <div className="card-body">
                                ...
                                <div className="user">
                                    ...
                                    <div className="user-info">
                                        ...
                                        <h5>{product.prod_begin_price}<span>$</span></h5>
